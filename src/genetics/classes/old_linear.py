...
class Linear:
    ...
    def step(self):
        ...
        match addr_mode:
            ...
            case Linear.INDIRECT:  operand = self.mem[self.mem[operand_spec % len(self.mem)] % len(self.mem)]
        ...
        match op:
            ...
            case Linear.STORE:
                ...
                match addr_mode:
                    ...
                    case Linear.INDIRECT: self.mem[self.mem[operand_spec % len(self.mem)] % len(self.mem)] = self.mem[target_reg]
            case Linear.ADD: self.mem[target_reg] += operand
            case Linear.SUB: self.mem[target_reg] -= operand
            case Linear.MUL:
                print(self.mem[target_reg], operand)
                self.mem[target_reg] *= operand
